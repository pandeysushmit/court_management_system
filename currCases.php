...
<section class="intro">
  <div class="bg-image h-100" style="background-image: url(https://c4.wallpaperflare.com/wallpaper/307/345/278/scales-wallpaper-preview.jpg); background-size:100% ">
            ...
            <div class="card mask-custom" style="background:transparent;">
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <thead>
      <tr><th colspan="7" style="text-align:center;">Applicant Details</th></tr> 
      <tr>
        <th class="">S.No.</th>
        <th class="">Case Title </th>
        <th class="">Accused</th>
        <th class="">Date</th>
        <th class="">Case Filing Date</th>
        <th class="" colspan=2 style="text-align:center">Options</th>
      </tr>
    </thead>
    <?php
    ...
    <tr>
      ...
      <td><?=$row["Lawyer"]?></td>
      <td><?=$row["Case_Date"]?></td>
      <td><button class="btn btn-outline-primary"><a href="update.php?updateid='<?=$row['id']?>'">Know Status</a></button></td>
      <td><button class="btn btn-outline-danger text-decoration-none"><a href="delete.php?deleteid='<?=$row['id']?>'">Withdraw</a></button></td>
    </tr>
    <?php
            $count=$count+1;
