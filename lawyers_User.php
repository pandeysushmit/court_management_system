...
<nav  class="navbar navbar-expand-lg navbar-light px-5" style="background-color:  #37c2e9;">
    <a href="user_page.php"><i class="navbar-brand ml-5" onclick="openNav()" style="color: red">
            ...
            <div class="card mask-custom" style="background:transparent;">
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <thead>
      <tr><th colspan="4" style="text-align:center;">Lawyers Details</th></tr> 
      <tr>
        <th class="text-align:center">Lawyer ID</th>
        <th class="">Name </th>
        <th class="">Contact</th>
        <th class="">Address</th>
