  ...
  <div class="bg-image h-100" style="background-image: url(https://c4.wallpaperflare.com/wallpaper/307/345/278/scales-wallpaper-preview.jpg); background-size:100% ">
    <div class="mask d-flex align-items-center h-100">
      ...
      <tr>
        ...
        <th class="" colspan=2 style="text-align:center">Operations</th>
      </tr>
    </thead>
    <?php
    ...
    <tr>
      ...
      <td><?=$row["email"]?></td>
      <td><?=$row["user_type"]?></td>
      <td><button class="btn btn-outline-primary"><a href="update.php?updateid='<?=$row['id']?>'">Update</a></button></td>
      <td><button class="btn btn-outline-danger"><a href="delete.php?deleteid='<?=$row['id']?>'">Delete</a></button></td>
    </tr>
    <?php
            $count=$count+1;
